...
FRAMEWORK_LINEAGE_API_NEEDS_UPDATE_TEXT := $(TOPDIR)vendor/ariel/build/core/apicheck_msg_current.txt

BUILD_RRO_SYSTEM_PACKAGE := $(TOPDIR)vendor/ariel/build/core/system_rro.mk

# Rules for MTK targets
include $(TOPDIR)vendor/ariel/build/core/mtk_target.mk

# Rules for QCOM targets
include $(TOPDIR)vendor/ariel/build/core/qcom_target.mk
