...
/**
 * The ArielDatabaseHelper allows creation of a database to store Ariel specific settings for a user
 * in System, Secure, and Global tables.
 */
public class ArielDatabaseHelper extends SQLiteOpenHelper{
    private static final String TAG = "ArielDatabaseHelper";
    ...
    /**
     * Creates an instance of {@link ArielDatabaseHelper}
     * @param context
     * @param userId
     */
    public ArielDatabaseHelper(Context context, int userId) {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        try {
            createDbTable(db, ArielTableNames.TABLE_SYSTEM);
            createDbTable(db, ArielTableNames.TABLE_SECURE);

            if (mUserHandle == UserHandle.USER_OWNER) {
                createDbTable(db, ArielTableNames.TABLE_GLOBAL);
            }
