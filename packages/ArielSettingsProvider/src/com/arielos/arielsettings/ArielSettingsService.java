...
final public class ArielSettingsService extends Binder {
    final ArielSettingsProvider mProvider;

    public ArielSettingsService(ArielSettingsProvider provider) {
        mProvider = provider;
    }
    ...
    protected void dump(FileDescriptor fd, PrintWriter pw, String[] args) {
        if (mProvider.getContext().checkCallingPermission(android.Manifest.permission.DUMP)
            ...
            pw.println("Permission Denial: can't dump ArielSettingsProvider from from pid="
    ...
    final static class MyShellCommand extends ShellCommand {
        ...
        MyShellCommand(ArielSettingsProvider provider, boolean dumping) {
            mProvider = provider;
            mDumping = dumping;
        }
        ...
        public int onCommand(String cmd) {
            ...
            try {
                holder = ActivityManager.getService().getContentProviderExternal(
                        ArielSettings.AUTHORITY, UserHandle.USER_SYSTEM, token, null);
                if (holder == null) {
        ...
        static void dumpHelp(PrintWriter pw, boolean dumping) {
            if (dumping) {
                ...
                pw.println("  get [--user <USER_ID> | current] [--ariel] NAMESPACE KEY");
                pw.println("      Retrieve the current value of KEY.");
                pw.println("  put [--user <USER_ID> | current] [--ariel] NAMESPACE KEY VALUE [TAG] [default]");
                ...
                pw.println("  delete [--user <USER_ID> | current] [--ariel] NAMESPACE KEY");
                pw.println("      Delete the entry for KEY.");
                pw.println("  reset [--user <USER_ID> | current] [--ariel] NAMESPACE {PACKAGE_NAME | RESET_MODE}");
                ...
                pw.println("  list [--user <USER_ID> | current] [--ariel] NAMESPACE");
