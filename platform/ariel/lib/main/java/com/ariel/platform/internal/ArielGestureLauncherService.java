 ...
 * @hide
 */
public class ArielGestureLauncherService extends ArielSystemService {
    ...
    public ArielGestureLauncherService(Context context) {
        super(context);
        mContext = context;
    }
    ...
    public String getFeatureDeclaration() {
        ...
        return "ArielGestureLauncherService";
    }
