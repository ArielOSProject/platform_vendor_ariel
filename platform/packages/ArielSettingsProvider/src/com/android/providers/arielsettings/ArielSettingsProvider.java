...
public class ArielSettingsProvider extends ContentProvider {
    ...
    public Bundle call(String method, String request, Bundle args) {
        ...
        // Get methods
        if (ArielSettings.CALL_METHOD_GET_SYSTEM.equals(method)) {
            return lookupSingleValue(callingUserId, ArielSettings.System.CONTENT_URI, request);
        }
        else if (ArielSettings.CALL_METHOD_GET_SECURE.equals(method)) {
            return lookupSingleValue(callingUserId, ArielSettings.Secure.CONTENT_URI, request);
        }
        else if (ArielSettings.CALL_METHOD_GET_GLOBAL.equals(method)) {
            return lookupSingleValue(callingUserId, ArielSettings.Global.CONTENT_URI, request);
        }
        ...
        if (ArielSettings.CALL_METHOD_PUT_SYSTEM.equals(method)) {
            insertForUser(callingUserId, ArielSettings.System.CONTENT_URI, values);
        }
        else if (ArielSettings.CALL_METHOD_PUT_SECURE.equals(method)) {
            insertForUser(callingUserId, ArielSettings.Secure.CONTENT_URI, values);
        }
        else if (ArielSettings.CALL_METHOD_PUT_GLOBAL.equals(method)) {
            insertForUser(callingUserId, ArielSettings.Global.CONTENT_URI, values);
        }
