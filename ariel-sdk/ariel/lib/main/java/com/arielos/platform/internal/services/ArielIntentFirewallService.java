...
/**
 * Service that handles Intent firewall rules
 *
 * @hide
 */
public class ArielIntentFirewallService extends ArielSystemService {
    ...
    public String getFeatureDeclaration() {
        return ArielContextConstants.Features.INTENT_FIREWALL;
    }
    ...
    private boolean createAppRuleFile(final String packageName) {
        try {
            Log.d(TAG, "Creating app rule file");
    ...
    private boolean removeRuleFile(final String fileName) {
        try {
            Log.d(TAG, "Removing rule file: "+fileName);
    ...
    private final IBinder mService = new IIntentFirewallInterface.Stub() {
