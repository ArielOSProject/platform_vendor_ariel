...
/**
 * ArielSettings contains Ariel specific preferences in System, Secure, and Global.
 */
public final class ArielSettings {
    ...
    /**
     * System settings, containing miscellaneous Ariel system preferences. This table holds simple
    ...
    public static final class System extends Settings.NameValueTable {
         ...
         * it throws {@link ArielSettingNotFoundException}.
         *
         * @param cr The ContentResolver to access.
         * @param name The name of the setting to retrieve.
         *
         * @throws ArielSettingNotFoundException Thrown if a setting by the given
    ...
    /**
     * Secure settings, containing miscellaneous Ariel secure preferences. This
    ...
    public static final class Secure extends Settings.NameValueTable {
        ...
        /**
         * Whether to enable "panic mode" for the current user.
    ...
    /**
     * Global settings, containing miscellaneous Ariel global preferences. This
     * table holds simple name/value pairs. There are convenience
     * functions for accessing individual settings entries.
     */
